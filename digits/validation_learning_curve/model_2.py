...
# k é quantos atributos gostariamos de trabalhar, ou seja, 20 atributos
...
for index, data in enumerate(scores):
    plt.text(x=index+0.6,y=normalized[index]+0.01,s='{0:.2f}'.format(normalized[index]),
             fontdict=dict(fontsize=8), rotation=90)
